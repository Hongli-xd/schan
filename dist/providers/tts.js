...
class Qwen3TtsProvider {
    ...
    async *synthesizeStream(text) {
        ...
        const sr = validRates.includes(this.sampleRate) ? this.sampleRate : 16000;
        let opusEncoder;
        try {
            opusEncoder = new OpusScript(sr, 1, OpusScript.Application.AUDIO);
        }
        catch (e) {
            ...
            while (true) {
                ...
                for (const line of lines) {
                    ...
                    try {
                        ...
                        if (pcmBuffer.length <= prevPcmLen)
                            continue;
...
class MockTtsProvider {
    ...
    constructor(log) {
        this.log = log;
        this.opusEncoder = new OpusScript(16000, 1, OpusScript.Application.AUDIO);
    }
    async *synthesizeStream(text) {
