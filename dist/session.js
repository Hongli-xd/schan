...
export class XiaozhiSession {
    ...
    async waitForHello() {
        ...
        const sampleRate = validRates.includes(this.audioParams.sample_rate) ? this.audioParams.sample_rate : 16000;
        this.opusDecoder = new OpusScript(sampleRate, this.audioParams.channels, OpusScript.Application.VOIP);
    ...
    async handleText(raw) {
        try {
            ...
            this.log.info?.(`[${this.connectionId}] handleText type: ${msg.type}`);
            switch (msg.type) {
                case "hello":
